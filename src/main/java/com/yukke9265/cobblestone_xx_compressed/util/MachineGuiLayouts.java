...
public final class MachineGuiLayouts {
    ...
    public static final class ReactionChamber {
        ...
        public static final int INPUT_SLOT_1_X = 36;
        public static final int INPUT_SLOT_1_Y = MACHINE_SLOT_Y - 9;//二段あるので、少し上にずらす
        public static final int INPUT_SLOT_2_X = INPUT_SLOT_1_X + SLOT_SIZE;
        public static final int INPUT_SLOT_2_Y = MACHINE_SLOT_Y - 9;//二段あるので、少し上にずらす
        public static final int FLUID_SLOT_X = INPUT_SLOT_1_X;
        public static final int FLUID_SLOT_Y = INPUT_SLOT_1_Y + SLOT_SIZE;//二段目
        public static final int OUTPUT_SLOT_X = INPUT_SLOT_2_X + SLOT_SIZE + 40;
        public static final int OUTPUT_SLOT_Y = MACHINE_SLOT_Y; // 出力は一段なので中心 
        public static final int POWER_SLOT_X = 10;
        public static final int POWER_SLOT_Y = 51;
        public static final int PROGRESS_BAR_X = 80;
    ...
    public static final class DissolutionChamber {
        ...
        public static final int INPUT_SLOT_Y = MACHINE_SLOT_Y;
        public static final int INPUT_FLUID_SLOT_X = INPUT_SLOT_X + SLOT_SIZE + 2;
        public static final int INPUT_FLUID_SLOT_Y = INPUT_SLOT_Y;
        public static final int OUTPUT_FLUID_SLOT_X = INPUT_SLOT_X + SLOT_SIZE*2 + 35;
        public static final int OUTPUT_FLUID_SLOT_Y = INPUT_SLOT_Y;
        public static final int POWER_SLOT_X = 10;
        public static final int POWER_SLOT_Y = 51;
        public static final int PROGRESS_BAR_X = 80;
        public static final int PROGRESS_BAR_Y = MACHINE_SLOT_Y;
        ...
        public static final int POWER_BAR_WIDTH = 124;
        public static final int POWER_BAR_HEIGHT = 8;
        public static final int INPUT_FLUID_FILL_X = INPUT_FLUID_SLOT_X;
        public static final int INPUT_FLUID_FILL_Y = INPUT_FLUID_SLOT_Y;
        public static final int OUTPUT_FLUID_FILL_X = OUTPUT_FLUID_SLOT_X;
        public static final int OUTPUT_FLUID_FILL_Y = OUTPUT_FLUID_SLOT_Y;
        public static final int FLUID_FILL_WIDTH = 16;
        public static final int FLUID_FILL_HEIGHT = 16;

        private DissolutionChamber() {
        }
    }
    ...
    public static final class FluidMixer {
        ...
        public static final int INPUT_FLUID_1_SLOT_Y = SLOT_Y;
        public static final int INPUT_FLUID_2_SLOT_X = INPUT_FLUID_1_SLOT_X + SLOT_SIZE;
        public static final int INPUT_FLUID_2_SLOT_Y = SLOT_Y;
        public static final int INPUT_ITEM_SLOT_X = INPUT_FLUID_1_SLOT_X;
        public static final int INPUT_ITEM_SLOT_Y = SLOT_Y;
        public static final int OUTPUT_FLUID_SLOT_X = INPUT_FLUID_2_SLOT_X + SLOT_SIZE + 40;
        public static final int OUTPUT_FLUID_SLOT_Y = SLOT_Y;
        public static final int POWER_SLOT_X = 10;
        public static final int POWER_SLOT_Y = 51;
        public static final int PROGRESS_BAR_X = 80;
        public static final int PROGRESS_BAR_Y = SLOT_Y;
        public static final int PROGRESS_BAR_WIDTH = 16;
        public static final int PROGRESS_BAR_HEIGHT = 16;
        public static final int POWER_BAR_X = 36;
        public static final int POWER_BAR_Y = 63;
        public static final int POWER_BAR_WIDTH = 124;
        public static final int POWER_BAR_HEIGHT = 8;
        public static final int INPUT_FLUID_1_FILL_X = INPUT_FLUID_1_SLOT_X;
        public static final int INPUT_FLUID_1_FILL_Y = INPUT_FLUID_1_SLOT_Y;
        public static final int INPUT_FLUID_2_FILL_X = INPUT_FLUID_2_SLOT_X;
        public static final int INPUT_FLUID_2_FILL_Y = INPUT_FLUID_2_SLOT_Y;
        public static final int OUTPUT_FLUID_FILL_X = OUTPUT_FLUID_SLOT_X;
        public static final int OUTPUT_FLUID_FILL_Y = OUTPUT_FLUID_SLOT_Y;
        public static final int FLUID_FILL_WIDTH = 16;
        public static final int FLUID_FILL_HEIGHT = 16;
