...
public class CobblestonexXCompressed {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ModItems.FLYING_STONE.get());
                ...
                output.accept(ModItems.COBBLESTONE_PARALLEL_CHIP.get());
    ...
    private void registerCapabilities(RegisterCapabilitiesEvent event) {
        ...
        event.registerBlockEntity(
            Capabilities.ItemHandler.BLOCK,
            ModBlockEntities.STONE_BREAK_SIMULATOR_BLOCK_ENTITY.get(),
            (blockEntity, side) -> blockEntity.getAutomationItemHandler(side)
        );
        ...
        event.registerBlockEntity(
            Capabilities.ItemHandler.BLOCK,
            ModBlockEntities.COBBLESTONE_CRYSTALLIZATION_CHAMBER_BLOCK_ENTITY.get(),
            (blockEntity, side) -> blockEntity.getAutomationItemHandler(side)
        );
        ...
        event.registerBlockEntity(
            Capabilities.ItemHandler.BLOCK,
            ModBlockEntities.COBBLESTONE_DISSOLUTION_CHAMBER_BLOCK_ENTITY.get(),
            (blockEntity, side) -> blockEntity.getAutomationItemHandler(side)
        );
        ...
        event.registerBlockEntity(
            Capabilities.ItemHandler.BLOCK,
            ModBlockEntities.COBBLESTONE_FLUID_MIXER_BLOCK_ENTITY.get(),
            (blockEntity, side) -> blockEntity.getAutomationItemHandler(side)
        );
