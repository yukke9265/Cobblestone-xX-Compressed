...
public final class CobblestoneMixerRecipeDatagen {
    private static final MixerRecipeDefinition[] RECIPES = new MixerRecipeDefinition[] {
        ...
        new MixerRecipeDefinition("emerald_dust_and_ender_dust_to_emerald_mixtures", sizedTag(ModItemTags.DUSTS_EMERALD), sizedTag(ModItemTags.DUSTS_ENDER_PEARL), new ItemStack(ModItems.EMERALD_MIXTURES.get(), 2), 6400, 16),
