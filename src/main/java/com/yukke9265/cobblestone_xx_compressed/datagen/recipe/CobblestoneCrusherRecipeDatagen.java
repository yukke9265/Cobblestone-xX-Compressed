...
public final class CobblestoneCrusherRecipeDatagen {
    private static final CrusherRecipeDefinition[] RECIPES = new CrusherRecipeDefinition[] {
        ...
        new CrusherRecipeDefinition("cobblestone_wire_to_string", ModItems.COBBLESTONE_WIRE.get(), new ItemStack(Items.STRING, 1), 800, 4),
        new CrusherRecipeDefinition("tier_copper_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.COPPER.getItem().get(), new ItemStack(Items.STRING, 2), 800, 4),
        new CrusherRecipeDefinition("tier_iron_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.IRON.getItem().get(), new ItemStack(Items.STRING, 4), 800, 4),
        new CrusherRecipeDefinition("tier_gold_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.GOLD.getItem().get(), new ItemStack(Items.STRING, 8), 800, 4),
        new CrusherRecipeDefinition("tier_amethyst_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.AMETHYST.getItem().get(), new ItemStack(Items.STRING, 16), 800, 4),
        new CrusherRecipeDefinition("tier_aquamarine_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.AQUAMARINE.getItem().get(), new ItemStack(Items.STRING, 32), 800, 4),
        new CrusherRecipeDefinition("tier_topaz_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.TOPAZ.getItem().get(), new ItemStack(Items.STRING, 64), 800, 4),
        new CrusherRecipeDefinition("tier_ruby_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.RUBY.getItem().get(), new ItemStack(Items.STRING, 64), 800, 4),
        new CrusherRecipeDefinition("tier_sapphire_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.SAPPHIRE.getItem().get(), new ItemStack(Items.STRING, 64), 800, 4),
        new CrusherRecipeDefinition("tier_diamond_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.DIAMOND.getItem().get(), new ItemStack(Items.STRING, 64), 800, 4),
        new CrusherRecipeDefinition("tier_emerald_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.EMERALD.getItem().get(), new ItemStack(Items.STRING, 64), 800, 4),
        new CrusherRecipeDefinition("tier_netherite_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.NETHERITE.getItem().get(), new ItemStack(Items.STRING, 64), 800, 4),
        new CrusherRecipeDefinition("tier_obsidian_cobblestone_wire_to_string", ModItems.TierCobblestoneWire.OBSIDIAN.getItem().get(), new ItemStack(Items.STRING, 64), 800, 4),
        ...
        new CrusherRecipeDefinition("cobblestone_to_gravel", Items.COBBLESTONE, Items.GRAVEL, 800, 4),
        new CrusherRecipeDefinition("gravel_to_sand", Items.GRAVEL, Items.SAND, 800, 4)
    };
