...
public class ModBlockLootTableProvider implements DataProvider {
    ...
    public CompletableFuture<?> run(@NotNull CachedOutput cache) {
        ...
        futures.add(DataProvider.saveStable(cache, createSimpleSelfDropLoot("cobblestone_shield_projector"), rootPath.resolve("cobblestone_shield_projector.json")));
        ...
        futures.add(DataProvider.saveStable(cache, createSimpleSelfDropLoot("cobblestone_melter"), rootPath.resolve("cobblestone_melter.json")));
        ...
        futures.add(DataProvider.saveStable(cache, createSimpleSelfDropLoot("cobblestone_enchanter"), rootPath.resolve("cobblestone_enchanter.json")));
        ...
        futures.add(DataProvider.saveStable(cache, createSimpleSelfDropLoot("cobblestone_powered_crafter"), rootPath.resolve("cobblestone_powered_crafter.json")));
        futures.add(DataProvider.saveStable(cache, createSimpleSelfDropLoot("stone_break_simulator"), rootPath.resolve("stone_break_simulator.json")));
        ...
        futures.add(DataProvider.saveStable(cache, createSimpleSelfDropLoot("cobblestone_water_generator"), rootPath.resolve("cobblestone_water_generator.json")));
        ...
        futures.add(DataProvider.saveStable(cache, createSimpleSelfDropLoot("cobblestone_drawer"), rootPath.resolve("cobblestone_drawer.json")));
        futures.add(DataProvider.saveStable(cache, createSimpleSelfDropLoot("cobblestone_fe_cube"), rootPath.resolve("cobblestone_fe_cube.json")));
