...
public class CobblestoneEnchanterMenu extends BaseMenu {
    ...
    public boolean isSoundMuted() {
        return this.enchanterData.get(DATA_INDEX_SOUND_MUTED) != 0;
    }
    ...
    public boolean clickMenuButton(@Nonnull Player player, int id) {
        ...
        if (this.handleAutoInsertButtonClick(this.enchanterBlockEntity, id)) {
            return true;
        }

        return this.handleMuteSoundButtonClick(this.enchanterBlockEntity, id);
    }
