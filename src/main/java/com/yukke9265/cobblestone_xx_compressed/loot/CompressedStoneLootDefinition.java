...
public class CompressedStoneLootDefinition {
    ...
    private static final List<CompressedStoneLootDefinition> DEFINITIONS = List.of(
        ...
        new CompressedStoneLootDefinition(ModBlocks.TierCompressedStone.AQUAMARINE.getBlock(), ModBlocks.TierCompressedCobblestone.AQUAMARINE.getBlock(), ModItems.TierCobblestoneGem.AQUAMARINE.getItem(), 0.12d, () -> Items.PRISMARINE_CRYSTALS, 0.45d, 1.0d, 3.0d),
        new CompressedStoneLootDefinition(ModBlocks.TierCompressedStone.TOPAZ.getBlock(), ModBlocks.TierCompressedCobblestone.TOPAZ.getBlock(), ModItems.TierCobblestoneGem.TOPAZ.getItem(), 0.12d, () -> Items.QUARTZ, 0.4d, 1.0d, 2.0d),
        new CompressedStoneLootDefinition(ModBlocks.TierCompressedStone.RUBY.getBlock(), ModBlocks.TierCompressedCobblestone.RUBY.getBlock(), ModItems.TierCobblestoneGem.RUBY.getItem(), 0.12d, () -> Items.REDSTONE, 0.45d, 1.0d, 4.0d),
        new CompressedStoneLootDefinition(ModBlocks.TierCompressedStone.SAPPHIRE.getBlock(), ModBlocks.TierCompressedCobblestone.SAPPHIRE.getBlock(), ModItems.TierCobblestoneGem.SAPPHIRE.getItem(), 0.12d, () -> Items.LAPIS_LAZULI, 0.45d, 2.0d, 5.0d),
