...
public class CobblestoneLaserDrillRecipeCategory implements IRecipeCategory<CobblestoneLaserDrillRecipe> {
    ...
    private static final int INPUT_SLOT_X = MachineGuiLayouts.LaserDrill.INPUT_SLOT_X - BACKGROUND_U;
    private static final int INPUT_SLOT_Y = MachineGuiLayouts.LaserDrill.MACHINE_SLOT_Y - BACKGROUND_V;
    private static final int POWER_SLOT_X = MachineGuiLayouts.LaserDrill.POWER_SLOT_X - BACKGROUND_U;
    private static final int POWER_SLOT_Y = MachineGuiLayouts.LaserDrill.POWER_SLOT_Y - BACKGROUND_V;
    private static final int OUTPUT_SLOT_1_X = MachineGuiLayouts.LaserDrill.OUTPUT_SLOT_1_X - BACKGROUND_U;
    private static final int OUTPUT_SLOT_1_Y = INPUT_SLOT_Y;
    private static final int OUTPUT_SLOT_2_X = MachineGuiLayouts.LaserDrill.OUTPUT_SLOT_2_X - BACKGROUND_U;
    private static final int OUTPUT_SLOT_2_Y = INPUT_SLOT_Y;
    private static final int PROGRESS_FRAME_X = MachineGuiLayouts.LaserDrill.PROGRESS_BAR_X - BACKGROUND_U;
    private static final int PROGRESS_FRAME_Y = MachineGuiLayouts.LaserDrill.PROGRESS_BAR_Y - BACKGROUND_V;
    ...
    private static final int NON_CONSUMING_LABEL_X = INPUT_SLOT_X + 3;
    private static final int NON_CONSUMING_LABEL_Y = INPUT_SLOT_Y + SLOT_SIZE + 3;

    private final IDrawable background;
    private final IDrawable icon;

    public CobblestoneLaserDrillRecipeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.createDrawable(BACKGROUND_TEXTURE, BACKGROUND_U, BACKGROUND_V, BACKGROUND_WIDTH, BACKGROUND_HEIGHT);
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(ModBlocks.COBBLESTONE_LASER_DRILL.get()));
    }
    ...
    public void draw(CobblestoneLaserDrillRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, "NC", NON_CONSUMING_LABEL_X, NON_CONSUMING_LABEL_Y, 0x404040, false);
