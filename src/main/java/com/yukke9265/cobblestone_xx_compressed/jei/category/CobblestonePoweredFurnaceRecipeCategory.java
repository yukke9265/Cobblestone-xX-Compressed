...
public class CobblestonePoweredFurnaceRecipeCategory extends JeiRecipeCategoryWithCpPowerSlot<RecipeHolder<CobblestonePoweredFurnaceRecipe>> {
    ...
    public CobblestonePoweredFurnaceRecipeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.createDrawable(BACKGROUND_TEXTURE, BACKGROUND_U, BACKGROUND_V, BACKGROUND_WIDTH, BACKGROUND_HEIGHT);
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(ModBlocks.COBBLESTONE_POWERED_FURNACE.get()));
    }
