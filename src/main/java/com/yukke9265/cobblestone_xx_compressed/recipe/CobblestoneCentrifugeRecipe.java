...
public class CobblestoneCentrifugeRecipe implements Recipe<SingleRecipeInput> {
    public static final MapCodec<CobblestoneCentrifugeRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
        Ingredient.CODEC.fieldOf("ingredient").forGetter(CobblestoneCentrifugeRecipe::getIngredient),
        ItemStack.CODEC.fieldOf("result_1").forGetter(CobblestoneCentrifugeRecipe::getFirstResult),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CobblestoneCentrifugeRecipe> STREAM_CODEC = new StreamCodec<>() {
        @Override
        public CobblestoneCentrifugeRecipe decode(RegistryFriendlyByteBuf buf) {
        ...
        @Override
        public void encode(RegistryFriendlyByteBuf buf, CobblestoneCentrifugeRecipe recipe) {
    ...
    public RecipeSerializer<? extends Recipe<SingleRecipeInput>> getSerializer() {
        return ModRecipeSerializers.COBBLESTONE_CENTRIFUGE.get();
    }

    @Override
    public RecipeType<? extends Recipe<SingleRecipeInput>> getType() {
        return ModRecipeTypes.COBBLESTONE_CENTRIFUGE.get();
    }
}